// src/gtk3/MainWindow.cpp (GTK3 port)
...
void MainWindow::loadCss() {
    ...
    // GTK3: gtk_css_provider_load_from_data instead of gtk_css_provider_load_from_string
    gtk_css_provider_load_from_data(css, kAppCss, -1, nullptr);
    // GTK3: gdk_screen_get_default instead of gdk_display_get_default
...
void MainWindow::buildWidgets() {
    ...
    gtk_widget_set_no_show_all(debugBtn, TRUE);  // GTK3: hidden by default
...
void MainWindow::onAddPlugin(int slot) {
    if (audio_->state() != AudioEngine::State::Running) {
        ...
        // GTK3: synchronous gtk_dialog_run
